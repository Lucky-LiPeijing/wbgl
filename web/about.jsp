...
<section class="container">
    <div class="container-fluid">
        <div class="about">
            <h2>Just about me</h2>
            <ul>
                <p>一枚正在努力进步的javaWeb程序员。</p>
            </ul>

            <h2>Contact  me</h2>
            <ul>
                <p><i class="Hui-iconfont">&#xe67b;</i>qq : 623620767 </p>
                <p><i class="Hui-iconfont">&#xe6d1;</i>git：https://github.com/android-LPJ</p>
                <p><i class="Hui-iconfont">&#xe63b;</i>email : 623620767@qq.com</p>
            </ul>
        </div>
